...
def send_verification_email(email, name, verification_url):
    try:
        ...
        # Try using Mailjet REST API directly
        try:
                ...
                'Messages': [
                    {
                        ...
                        'Subject': 'Verify Your Email for Pawfect Pet Adoption',
                        ...
                        <head>
                            ...
                            <title>Verify Your Email - Pawfect</title>
                            <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
                        </head>
                        <body style="margin: 0; padding: 0; font-family: 'Poppins', Arial, sans-serif; background-color: #f8f8f8; color: #212121;">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
                                <!-- Header with Logo -->
                                <tr>
                                    <td align="center" style="padding: 30px 20px 20px 20px; background-color: #fff; border-top-left-radius: 8px; border-top-right-radius: 8px; border-bottom: 1px solid #f0f0f0;">
                                        <img src="{os.getenv('SITE_URL')}/Img/Pawfect%20Logo.png" alt="Pawfect Logo" width="150" style="display: block; margin: 0 auto;">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 40px 30px;">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #F7871F; text-align: center;">Welcome to Pawfect!</h1>
                                                    <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.5; color: #444444;">Hi {name},</p>
                                                    <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.5; color: #444444;">Thank you for joining Pawfect Pet Adoption. We're excited to help you find your perfect pet companion! Please verify your email address to complete your registration.</p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center" style="padding: 30px 0;">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center" style="border-radius: 50px;" bgcolor="#F7871F">
                                                                <a href="{verification_url}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Poppins', Arial, sans-serif; font-size: 16px; font-weight: 600; color: white; text-decoration: none; border-radius: 50px;">
                                                                    Verify My Email
                                                                </a>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="margin: 0 0 10px; font-size: 14px; line-height: 1.5; color: #666666; text-align: center;">If the button doesn't work, copy and paste this URL into your browser:</p>
                                                    <p style="margin: 0 0 25px; font-size: 14px; line-height: 1.5; color: #666666; text-align: center; word-break: break-all;">
                                                        <a href="{verification_url}" style="color: #F7871F; text-decoration: underline;">{verification_url}</a>
                                                    </p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="margin: 0 0 25px; font-size: 14px; line-height: 1.5; color: #666666; text-align: center; font-style: italic;">
                                            ...
                                            <tr>
                                                <td align="center" style="padding: 20px 0;">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="80%">
                                                        <tr>
                                                            <td style="padding: 20px; background-color: #FFF8EE; border-radius: 10px; border-left: 4px solid #F3B445;">
                                                                <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #555555; text-align: center;">
                                                                    <span style="font-weight: 600; color: #F7871F;">Pawfect Fact:</span> Did you know that adopting a pet can improve your mental health and reduce stress? Your journey to finding a furry friend starts now!
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                ...
                                <!-- Footer -->
                                <tr>
                                    <td style="padding: 20px; text-align: center; background-color: #f7f7f7; border-top: 1px solid #eeeeee; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                                        <p style="margin: 0 0 10px; font-size: 13px; line-height: 1.5; color: #888888;">
                                            If you didn't sign up for Pawfect, you can safely ignore this email.
                                        </p>
                                        <p style="margin: 0; font-size: 13px; line-height: 1.5; color: #888888;">
                                            &copy; 2025 Pawfect Pet Adoption. All rights reserved.
                                        </p>
                                    </td>
                                </tr>
                            </table>
            ...
            if result.status_code != 200:
                ...
                if response.status_code == 200:
                    ...
                    return send_verification_email_smtp(email, name, verification_url)
...
def send_verification_email_smtp(email, name, verification_url):
    """Fallback method to send verification email via SMTP"""
    try:
        import smtplib
        ...
        msg['Subject'] = 'Verify Your Email for Pawfect Pet Adoption'
        msg['From'] = sender_email
        msg['To'] = email

        # Add plain text and HTML parts
        text = f"Welcome to Pawfect! Please verify your email by clicking this link: {verification_url}"
        html = f'''
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f8f8f8; color: #212121;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: white;">
                <tr>
                    <td align="center" style="padding: 20px;">
                        <h1 style="color: #F7871F;">Welcome to Pawfect Pet Adoption!</h1>
                        <p>Hi {name},</p>
                        <p>Please verify your email by clicking: <a href="{verification_url}" style="color: #F7871F;">Verify Email</a></p>
                    </td>
                </tr>
            </table>
        </body>
        ...
        # Just return the verification URL for testing
        print(f"FOR TESTING: Use this verification URL manually: {verification_url}")
        return False
...
def root():
    return jsonify({
        "message": "Welcome to the Pawfect API",
        "status": "running",
        "available_endpoints": [
            "/api/login",
            "/api/register",
                ...
                'Messages': [
                    {
                        ...
                        <head>
                            <meta charset="UTF-8">
                            <meta name="viewport" content="width=device-width, initial-scale=1.0">
                            <title>Reset Your Password - Pawfect</title>
                            <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
                        </head>
                        <body style="margin: 0; padding: 0; font-family: 'Poppins', Arial, sans-serif; background-color: #f8f8f8; color: #212121;">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
                                ...
                                <tr>
                                    <td style="padding: 40px 30px;">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #F7871F; text-align: center;">Reset Your Password</h1>
                                                    <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.5; color: #444444;">Hi {name},</p>
                                                    <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.5; color: #444444;">We received a request to reset your password for your Pawfect account. Click the button below to create a new password.</p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center" style="padding: 30px 0;">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center" style="border-radius: 50px;" bgcolor="#F7871F">
                                                                <a href="{reset_url}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Poppins', Arial, sans-serif; font-size: 16px; font-weight: 600; color: white; text-decoration: none; border-radius: 50px;">
                                                                    Reset Password
                                                                </a>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="margin: 0 0 10px; font-size: 14px; line-height: 1.5; color: #666666; text-align: center;">If the button doesn't work, copy and paste this URL into your browser:</p>
                                                    <p style="margin: 0 0 25px; font-size: 14px; line-height: 1.5; color: #666666; text-align: center; word-break: break-all;">
                                                        <a href="{reset_url}" style="color: #F7871F; text-decoration: underline;">{reset_url}</a>
                                                    </p>
                                                </td>
                                            </tr>
                                                ...
                                                <td align="center" style="padding: 20px 0;">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="80%">
                                                        <tr>
                                                            <td style="padding: 20px; background-color: #FFF8EE; border-radius: 10px; border-left: 4px solid #F3B445;">
                                                                <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #555555; text-align: center;">
                                                                    <span style="font-weight: 600; color: #F7871F;">Security Note:</span> This link will expire in 24 hours for your protection. If you didn't request a password reset, please ignore this email or contact support.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
    ...
    try:
        ...
        <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f8f8f8; color: #212121;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: white;">
                <tr>
                    <td align="center" style="padding: 20px;">
                        <h1 style="color: #F7871F;">Reset Your Pawfect Password</h1>
                        <p>Hi {name},</p>
                        <p>Please click to reset your password: <a href="{reset_url}" style="color: #F7871F;">Reset Password</a></p>
